...
flowchart TB
    ...
    F --> G[07 PaperOut 使用指南<br/>组织并输出成果]
    G --> H[08 PaperOut 协作场景<br/>理解契约与路线图]
```
...
| 07 | [PaperOut To-Authors 使用指南](07-PaperOut%20To-Authors%20使用指南.md) | 怎样组织长文并完成正式输出 | 建立写作项目并导出 PDF 或 Word |
| 08 | [PaperOut 协作与使用场景](08-PaperOut%20协作与使用场景.md) | PaperOut 当前怎样与项目、概念和宿主协作 | 区分当前文件契约与尚未实现的路线图 |

## 推荐阅读方式

- **已经完成快速上手，准备系统学习**：按照 01—08 顺序阅读，并为操作型章节完成一次最小测试；
